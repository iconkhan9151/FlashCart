...
fun ItemsScreen(
    ...
    LazyVerticalGrid(
        ...
        item(span = { GridItemSpan(2) }
            ...
            Column {
                Image(painter = painterResource(id = R.drawable.grocery3), contentDescription = "Offer",modifier= Modifier.fillMaxWidth())
                Card(
...
fun ErrorScreen(flashViewModel: FlashViewModel){
    Column(
        ...
        Text(text = "Oops! Internet unavailable. Please check your connection and try again",
           modifier = Modifier
               .fillMaxWidth()
               .padding(20.dp),
            textAlign = TextAlign.Center
