...
import com.example.flash.data.Items
...
fun FlashApp(
    ...
    if (isVisible){
        ...
        Scaffold(
                    ...
                    title = {
                        Row(
                            ...
                            Row(
                               ...
                               Image(painter = painterResource(id = R.drawable.logout2), contentDescription ="Logout",
            ...
            NavHost(navController = navController, startDestination = FlashAppScreen.Start.name, Modifier.padding(it)){
